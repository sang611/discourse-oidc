...
module ::OmniAuth
  ...
  module Strategies
    class OpenIDConnect < OmniAuth::Strategies::OAuth2
      ...
      info do
        print "----------------------------" + userinfo_response.to_json
        ...
        prune!(
          ...
          name: data_source["attributes"]['fullName'],
          username: data_source["attributes"]['staffCode'],
          email: data_source["attributes"]['email'],
          nickname: data_source["attributes"]['staffCode']
        )
      end
      ...
      def callback_url
        SiteSetting.openid_connect_callback.presence ||
